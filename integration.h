...
protected:
	...
	double a_solar_pressure[3];    /*ускорение обусловленное действием
	...
	double df_solar_pressure[3][3];	  /*Матрица частных производных вектора
