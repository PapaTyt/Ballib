...
protected:
	...
	unsigned harmonicType 	  /*признак учета типа расчитываемых гармоник:
								0 - разложение гравитационного потенциала: вторая зональная гармоника С20
								1 - разложение гравитационного потенциала: четвертая зональная гармоника С40
								2 - разложение гравитационного потенциала: порядок разложения до 32х32*/
