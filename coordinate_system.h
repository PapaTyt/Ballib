...
//Преобразование Гринвической во Вторую Экваториальную(перевод только вектора)
void GEOtoGEI(const double Ar1[],const double t, double Ar2[]);
//Преобразование Второй Экваториальной в Гринвическую(перевод только вектора)
...
//Процедура перехода от J2000 к эклиптической СК с центром в точке L2 и осью Х направленной на Солнце
...
void J2000toEkl ( double r[3],double v[3], double t, double r1[3],double v1[3]);  //!!!требует проверки
//Процедура перехода из плоскости эклиптики (X направлен на Солнце) в J2000
void EkltoJ2000 ( double r[3],double v[3], double t, double r1[3],double v1[3]); //!!!требует проверки
